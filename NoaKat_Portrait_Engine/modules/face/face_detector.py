...
modules/face/, so detection works fully offline with no model download at
run time. This can be swapped for a deep-learning detector later without
changing the analyze/process/export interface.
"""
